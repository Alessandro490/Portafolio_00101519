...
Libro solicitarLibro(){
    ...
    do{
        ...
        switch(opcion){
            ...
            break;
            case 'm': p.genero = misterio;   continuar = false;contador++;
            break;
...
int main(){
    ...
    do{
        ...
        cout << "Menu: \n\t1) Agregar Libro\n\t2) Ver Libros"
            << "\n\t3) Eliminar libro\n\t4) Buscar Libro"
            << "\n\t5) buscar libro en espanol \n\t6) Eliminar todos los libros de misterio"
        ...
        switch(opcion){
            ...
            case 5: cout<<"buscando..."<<endl;
                 buscarespanol();
             break;
             case 6: cout<<"Eliminando..."<<endl;
                                 for(int i=0;i<contador;i++){
                    eliminarmisterio();
                }
             break;
             case 7: cout<<"Buscando..."<<endl;
                  buscarcienciaficcion();
             break;
